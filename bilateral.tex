...
%Stereo control thus implements an \NAP{} by sequencing lateral differences through habitat-shaped transfer functions (gravity for leveling; fluid for turning), with halts encoded as $u_{\text{steer}} \to 0$.
