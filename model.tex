...
\marginpar{Body-plan is dynamically coupled with the habitat and cannot be studied independently  as just anatomy.}
\todo{We need to expand on each of the principles, with a summary and citations on comparative anatomy and evo-devo review.}
...
\end{itemize}
\todo{Cross-reference those subsections here with \texttt{\textbackslash cref}.}
